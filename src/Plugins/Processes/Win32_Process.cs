...
namespace WMI.Win32
{
    ...
    public class Win32_Process : System.ComponentModel.Component
    {
        ...
        {
            this.InitializeObject(null, new System.Management.ManagementPath(Win32_Process.ConstructPath(keyHandle)),
                null);
        }

        public Win32_Process(System.Management.ManagementScope mgmtScope, string keyHandle)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)),
                new System.Management.ManagementPath(Win32_Process.ConstructPath(keyHandle)), null);
        }
        ...
        {
            get { return ((string)(curObj["CommandLine"])); }
        }
        ...
        {
            get { return ((string)(curObj["CSCreationClassName"])); }
        }
        ...
        {
            get { return ((string)(curObj["CSName"])); }
        }
        ...
        {
            get { return ((string)(curObj["ExecutablePath"])); }
        }
        ...
        {
            get { return ((string)(curObj["Handle"])); }
        }
...
Example: 20480.")]
        ...
        {
            get { return ((string)(curObj["OSCreationClassName"])); }
        }
        ...
        {
            get { return ((string)(curObj["OSName"])); }
        }
        ...
        {
            get { return ((string)(curObj["WindowsVersion"])); }
        }
        ...
        private bool CheckIfProperClass(System.Management.ManagementScope mgmtScope,
            System.Management.ManagementPath path, System.Management.ObjectGetOptions OptionsParam)
        {
            if (((path != null)
                 &&
                 (string.Compare(path.ClassName, this.ManagementClassName, true,
        ...
        private bool CheckIfProperClass(System.Management.ManagementBaseObject theObj)
        {
            if (((theObj != null)
                 &&
                 (string.Compare(((string)(theObj["__CLASS"])), this.ManagementClassName, true,
                     System.Globalization.CultureInfo.InvariantCulture) == 0)))
            {
                return true;
            }
            else
            {
                ...
                if ((parentClasses != null))
                {
                    ...
                    {
                        if (
                            (string.Compare(((string)(parentClasses.GetValue(count))), this.ManagementClassName, true,
                                System.Globalization.CultureInfo.InvariantCulture) == 0))
                        {
                            return true;
                        }
        ...
        private static string ToDmtfDateTime(System.DateTime date)
        {
            ...
            else
            {
                if ((tickOffset.Ticks >= 0))
                {
                    utcString = string.Concat("+",
                        ((long)((tickOffset.Ticks / System.TimeSpan.TicksPerMinute))).ToString().PadLeft(3, '0'));
                }
                else
                {
            ...
            System.DateTime dtTemp = new System.DateTime(date.Year, date.Month, date.Day, date.Hour, date.Minute,
                date.Second, 0);
        ...
        private static string ConstructPath(string keyHandle)
        {
            ...
            strPath = string.Concat(strPath,
                string.Concat(".Handle=", string.Concat("\"", string.Concat(keyHandle, "\""))));
            return strPath;
        }
        ...
        public static ProcessCollection GetInstances(System.Management.ManagementScope mgmtScope,
            ...
            string[] selectedProperties)
        {
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher =
                new System.Management.ManagementObjectSearcher(mgmtScope,
                    new SelectQuery("Win32_Process", condition, selectedProperties));
        ...
        public static Win32_Process CreateInstance()
        {
            ...
            System.Management.ManagementClass tmpMgmtClass = new System.Management.ManagementClass(mgmtScope, mgmtPath,
                null);
        ...
        public uint AttachDebugger()
        {
            if ((isEmbedded == false))
            {
                ...
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod(
                    "AttachDebugger", inParams, null);
        ...
        public static uint Create(string CommandLine, string CurrentDirectory,
            System.Management.ManagementBaseObject ProcessStartupInformation, out uint ProcessId)
        {
            ...
            if ((IsMethodStatic == true))
            {
                System.Management.ManagementBaseObject inParams = null;
                System.Management.ManagementPath mgmtPath = new System.Management.ManagementPath(CreatedClassName);
                System.Management.ManagementClass classObj = new System.Management.ManagementClass(statMgmtScope,
                    mgmtPath, null);
                ...
                inParams["ProcessStartupInformation"] =
                    ((System.Management.ManagementBaseObject)(ProcessStartupInformation));
        ...
        public uint GetAvailableVirtualSize(out ulong AvailableVirtualSize)
        {
            if ((isEmbedded == false))
            {
                ...
                System.Management.ManagementBaseObject outParams =
                    PrivateLateBoundObject.InvokeMethod("GetAvailableVirtualSize", inParams, null);
        ...
        public uint GetOwner(out string Domain, out string User)
        {
            if ((isEmbedded == false))
            {
                ...
                bool EnablePrivileges = PrivateLateBoundObject.Scope.Options.EnablePrivileges;
                PrivateLateBoundObject.Scope.Options.EnablePrivileges = true;
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("GetOwner",
                    inParams, null);
        ...
        public uint GetOwnerSid(out string Sid)
        {
            if ((isEmbedded == false))
            {
                ...
                bool EnablePrivileges = PrivateLateBoundObject.Scope.Options.EnablePrivileges;
                PrivateLateBoundObject.Scope.Options.EnablePrivileges = true;
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("GetOwnerSid",
                    inParams, null);
        ...
        public uint SetPriority(int Priority)
        {
            if ((isEmbedded == false))
            {
                ...
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("SetPriority",
                    inParams, null);
                PrivateLateBoundObject.Scope.Options.EnablePrivileges = EnablePrivileges;
                return System.Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
        ...
        public uint Terminate(uint Reason)
        {
            if ((isEmbedded == false))
            {
                ...
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("Terminate",
                    inParams, null);
                PrivateLateBoundObject.Scope.Options.EnablePrivileges = EnablePrivileges;
                return System.Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
        ...
        public class ProcessCollection : object, ICollection
        {
            ...
            public class ProcessEnumerator : object, System.Collections.IEnumerator
            {
                ...
                {
                    get { return new Win32_Process(((System.Management.ManagementObject)(privObjEnum.Current))); }
                }
        ...
        public class WMIValueTypeConverter : TypeConverter
        {
            ...
            public override PropertyDescriptorCollection GetProperties(
                System.ComponentModel.ITypeDescriptorContext context, object value, System.Attribute[] attributeVar)
            {
